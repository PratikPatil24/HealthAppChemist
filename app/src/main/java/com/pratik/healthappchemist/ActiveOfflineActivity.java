...
public class ActiveOfflineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_active_offline);
        ...
        recyclerView = findViewById(R.id.recyclerAOffline);
    ...
    void getData() {
        Log.d("Orders", "Fetching Active Offline Orders...");
        db.collection("chemists").document(mAuth.getCurrentUser().getPhoneNumber())
                .collection("activeorders")
                .whereEqualTo("orderType", "Offline")
                .get()
