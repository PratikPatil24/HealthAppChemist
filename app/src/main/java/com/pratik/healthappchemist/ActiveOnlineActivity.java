...
public class ActiveOnlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_active_online);
        ...
        recyclerView = findViewById(R.id.recyclerAOnline);
    ...
    void getData() {
        Log.d("Orders", "Fetching Active Online Orders...");
        db.collection("chemists").document(mAuth.getCurrentUser().getPhoneNumber())
                .collection("activeorders")
                .whereEqualTo("orderType", "Online")
                .get()
